...
int c[1001000], part[1001000], col[1001000];
ll ans, total[1001000];
...
bool cmp(node a, node b) {
  return ((part[a.l] < part[b.l]) ||
          ((part[a.l] == part[b.l]) && (a.r < b.r)) ||
          ((part[a.l] == part[b.l]) && (a.r == b.r) && (a.x < b.x)));
}
bool cmpwithid(node a, node b) { return a.id < b.id; }
...
int main() {
  ...
  for (int i = 1; i <= m; i++) {
    ...
    if (ch == 'Q') {
      ...
      chg[changenum].o = c[chg[changenum].x];
      c[chg[changenum].x] = chg[changenum].y;
    }
  }
